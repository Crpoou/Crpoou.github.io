...
class Rule {
  constructor(readonly tags: readonly Tag[], readonly mode: Mode, readonly context: readonly string[] | null, public next?: Rule) {}
...
class HighlightBuilder {
  class = ''
  constructor(public at: number, readonly highlighters: readonly Highlighter[], readonly span: (from: number, to: number, cls: string) => void) {}
